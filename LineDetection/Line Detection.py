...
# draw points
for point in points:
    image = cv2.circle(image, (point[0], point[1]), radius=3, color=(255, 0, 0), thickness=-1)
...
#     # plt.scatter(x2, y2)
#
#     # get the color where points lay
#     (b1, g1, r1) = threshold[y1, x1]
#     (b2, g2, r2) = threshold[y2, x2]
#
#     # draw points in original image
#     image = cv2.circle(image, (x1, y1), radius=3, color=(0, 0, 255), thickness=-1)
#     image = cv2.circle(image, (x2, y2), radius=3, color=(0, 0, 255), thickness=-1)
